...
public class SSUserDetailsService implements UserDetailsService{
   ...
   // public class SSUserDetailsService implements UserDetailsService {
        ...
        public UserDetails loadUserByUsername(String username) throws
            ...
            try{
                User appUser=userRepository.findByUsername(username);//upp user is the object of the user class
                if(appUser==null)  {
                    System.out.println("User is not fourndwith the provided username"
                            + appUser.toString());
                    return null;
                }
